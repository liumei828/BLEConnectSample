...
+ (PMVValue*) newValue: (NSInteger) type time: (NSTimeInterval) time {
    ...
    switch (type) {
        case Counter:
            ...
            break;
        case Motion:
            [value addNumber: [self randomNumberBetween:-32768 maxNumber: 32767]]; //x
            [value addNumber: [self randomNumberBetween:-32768 maxNumber: 32767]]; //y
            [value addNumber: [self randomNumberBetween:-32768 maxNumber: 32767]]; //z
            break;
        case HeartRate:
